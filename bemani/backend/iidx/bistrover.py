...
class IIDXBistrover(IIDXCourse, IIDXBase):
    ...
    def handle_IIDX28ranking_entry_request(self, request: Node) -> Node:
    ...
    def handle_IIDX28ranking_classicentry_request(self, request: Node) -> Node:
    ...
    def handle_IIDX28pc_shopregister_request(self, request: Node) -> Node:
    ...
    def handle_IIDX28gameSystem_systemInfo_request(self, request: Node) -> Node:
        return Node.void('IIDX28gameSystem')
